...
// A yxh config class. This is not required, but it's a good idea to have one to keep your config organized.
// Demonstrates how to use Forge's config APIs
@Mod.EventBusSubscriber(modid = Yxhsmod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Config {
